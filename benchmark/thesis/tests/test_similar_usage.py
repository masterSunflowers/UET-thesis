...
language_server = SyncLanguageServer.create(
    config, multilspy_logger, repository_root_path="/home/lvdthieu/Documents/Projects/UET-thesis/benchmark/data/java_repos_copy/burningtnt--SimpleWEBP--0bdd60c"
)
...
with service.language_server.start_server():
    print(service.execute_goto_definition(
        ...
        position=Point(row=339, column=22)
    ))
